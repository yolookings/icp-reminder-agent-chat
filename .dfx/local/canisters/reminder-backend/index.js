...
import { idlFactory } from './reminder-backend.did.js';
export { idlFactory } from './reminder-backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_REMINDER_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./reminder-backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the reminder-backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./reminder-backend.did.js")._SERVICE>}
 */
export const reminder_backend = createActor(canisterId);
